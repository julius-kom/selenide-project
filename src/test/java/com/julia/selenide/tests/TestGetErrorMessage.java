...
public class TestGetErrorMessage extends  BaseTest {
    ...
    @Test
    @DisplayName("Fill checkout information without postal code and continue")
    public void testGetErrorMessage() {
        ...
        checkoutPage
                .fillFirstNameInput("Julia")
                .fillLastNameInput("Komarova")
                .clickOnContinueBtn();

        assertThat(checkoutPage.getErrorMessage()).as("Error is not correct")
